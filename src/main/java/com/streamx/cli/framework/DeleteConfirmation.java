...
/**
 * GitHub-style guard for irreversible deletions: the user must type the exact ID of the
 * resource being deleted. {@code --force} skips the prompt (required in non-interactive
 * environments, where no answer can be read).
 */
