package com.streamx.cli.commands.profile.org.use;
...
@CommandLine.Command(
    name = "use",
    header = "Set the current organization for the active profile",
    description = "Commands taking an organization fall back to it when the argument is "
        + "omitted. Stored per profile; STREAMX_ORG overrides it for a single invocation."
)
